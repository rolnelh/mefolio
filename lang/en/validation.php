...
return [
    ...
    | comme les règles de taille. N’hésite pas à ajuster ces messages ici.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Tu peux définir ici des messages personnalisés pour des règles spécifiques.
    | Par exemple : 'email.required' => 'Nous avons besoin de votre adresse e-mail !'
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Ces lignes permettent de rendre les noms d’attributs plus lisibles.
    | Par exemple : au lieu de “email” → “adresse e-mail”.
    |
    */
