<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <a href="{{ route('blog.show', $featured) }}"
                ...
                <div class="absolute bottom-0 left-0 right-0 p-8">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <span class="text-xs text-gray-300">{{ $featured->category }} · {{ $featured->reading_minutes }} min de lecture</span>
                    </div>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-gray-300 text-xs">
                            {{ $featured->author->username ?? 'Équipe Mefolio' }} · {{ $featured->published_at?->format('d M Y') }}
                        </span>
                    </div>
                </div>
            </a>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7 mb-16">
                    ...
                    <a href="{{ route('blog.show', $article) }}">
                        ...
                        <div class="p-5">
                            <div class="flex items-center gap-2 mb-3">
                                ...
                                <span class="text-[11px] text-gray-400">{{ $article->reading_minutes }} min de lecture</span>
                            </div>
                            ...
                            <div class="flex items-center justify-between pt-3 border-t border-gray-50">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-[11px] text-gray-500 font-medium">{{ $article->author->username ?? 'Équipe Mefolio' }}</span>
                                </div>
            ...
            @empty
                <div class="col-span-full text-center py-20 text-gray-400">
                    <p class="text-sm font-medium">Aucun article publié pour le moment. Revenez bientôt !</p>
                </div>
            @endforelse
        </div>
        ...
        <x-newsletter-cta title="Newsletter Mefolio"
            description="Recevez chaque semaine les meilleurs articles, opportunités et actualités du monde créatif africain."
            source="blog" />
